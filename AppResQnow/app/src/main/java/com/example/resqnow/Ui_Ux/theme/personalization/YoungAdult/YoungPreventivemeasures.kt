...
@Composable
fun YoungPreventivemeasures(navController: NavController){
            ...
            item {
                ...
                Box(modifier = Modifier.fillMaxWidth().offset(y = -560.dp)) {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.quanhe),
                            contentDescription = "",
                            modifier = Modifier.size(250.dp)
                        )
                        Image(
                ...
                Box(modifier = Modifier.fillMaxWidth().offset(y = -840.dp)) {
                    Box(
                        modifier = Modifier
                            .align(Alignment.CenterStart)
                            .offset(y = -50.dp)
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.tamly),
                            contentDescription = "",
                            modifier = Modifier.size(250.dp)
                        )
                        Image(
