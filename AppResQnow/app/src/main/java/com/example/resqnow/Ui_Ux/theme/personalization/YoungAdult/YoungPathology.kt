package com.example.resqnow.Ui_Ux.theme.personalization.YoungAdult
...
@Composable
fun YoungPathology(navController: NavController) {
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.thanhnien),
            contentDescription = "thanhnien",
            modifier = Modifier
                .size(width = 200.dp, height = 150.dp)
                .align(Alignment.CenterHorizontally)
        )
        Image(
            painter = painterResource(id = R.drawable.thanhnien1),
            contentDescription = "",
            modifier = Modifier
        ...
        Text(
            text = "Một số bệnh hay mắc phải ở thanh niên ",
            fontSize = 19.sp,
            fontWeight = FontWeight.Black,
            color = Color.Red,
            modifier = Modifier
    ...
    LazyColumn(modifier = Modifier
        ...
        item {
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                Image(
                    painter = painterResource(id = R.drawable.dotquy1),
                    contentDescription = "",
                    modifier = Modifier
            ...
            Row(modifier = Modifier.offset(y = -150.dp)) {
                Image(
                    painter = painterResource(id = R.drawable.traitim),
                    contentDescription = "",
                    modifier = Modifier
                        .size(50.dp)
                        .offset(y = -25.dp)
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                Image(
                    painter = painterResource(id = R.drawable.traitim1),
                    contentDescription = "",
                    modifier = Modifier
                        .size(width = 410.dp, height = 260.dp)
                        .align(Alignment.Center)
            ...
            Row(modifier = Modifier.offset(y = -320.dp)) {
                Image(
                    painter = painterResource(id = R.drawable.khop),
                    contentDescription = "",
                    modifier = Modifier
                        .size(50.dp)
                        .offset(y = -25.dp)
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                Image(
                    painter = painterResource(id = R.drawable.khop1),
                    contentDescription = "",
                    modifier = Modifier
                        .size(width = 410.dp, height = 260.dp)
                        .align(Alignment.Center)
            ...
            Row(modifier = Modifier.offset(y = -470.dp)) {
                ...
                Text(
                    text = "4. Rối loạn tâm trí và stress",
                    fontSize = 15.sp,
                    fontWeight = FontWeight.Black,
                    modifier = Modifier
                        .padding(start = 16.dp)
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                Image(
                    painter = painterResource(id = R.drawable.stress1),
                    contentDescription = "",
                    modifier = Modifier
                        .size(width = 410.dp, height = 260.dp)
                        .align(Alignment.Center)
            ...
            Row(modifier = Modifier.offset(y = -630.dp)) {
                Image(
                    painter = painterResource(id = R.drawable.tieuduong),
                    contentDescription = "",
                    modifier = Modifier
                        .size(50.dp)
                        .offset(y = -25.dp)
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                Image(
                    painter = painterResource(id = R.drawable.tieuduong1),
                    contentDescription = "",
                    modifier = Modifier
                        .size(width = 410.dp, height = 260.dp)
                        .align(Alignment.Center)
            ...
            Box(modifier = Modifier.fillMaxWidth().padding(bottom = 350.dp)) {
                Image(
                    painter = painterResource(id = R.drawable.line),
                    contentDescription = "",
                    modifier = Modifier
