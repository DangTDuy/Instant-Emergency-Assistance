...
@Composable
fun SeniorPathology(navController: NavController) {
    ...
    LazyColumn(modifier = Modifier
        ...
        item {
            ...
            Row() {
                ...
                Text(
                    text = "1. Tăng huyết áp (huyết áp cao)",
                    fontSize = 15.sp,
                    fontWeight = FontWeight.Black,
                    modifier = Modifier
                        .padding(start = 16.dp)
            ...
            Row(modifier = Modifier.offset(y = -150.dp)) {
                Image(
                    painter = painterResource(id = R.drawable.momau),
                    contentDescription = "",
                    modifier = Modifier
                        .size(50.dp)
                        .offset(y = -25.dp)
                ...
                Text(
                    text = "2. Cholesterol cao (mỡ máu cao)",
                    fontSize = 15.sp,
                    fontWeight = FontWeight.Black,
                    modifier = Modifier
                        .padding(start = 16.dp)
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                Image(
                    painter = painterResource(id = R.drawable.momau1),
                    contentDescription = "",
                    modifier = Modifier
                        .size(width = 410.dp, height = 260.dp)
                        .align(Alignment.Center)
            ...
            Row(modifier = Modifier.offset(y = -290.dp)) {
                Image(
                    painter = painterResource(id = R.drawable.viemkhop),
                    contentDescription = "",
                    modifier = Modifier
                        .size(50.dp)
                        .offset(y = -25.dp)
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                Image(
                    painter = painterResource(id = R.drawable.viemkhop1),
                    contentDescription = "",
                    modifier = Modifier
                        .size(width = 410.dp, height = 260.dp)
                        .align(Alignment.Center)
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                Image(
                    painter = painterResource(id = R.drawable.dotquy),
                    contentDescription = "",
                    modifier = Modifier
                        .size(width = 410.dp, height = 260.dp)
                        .align(Alignment.Center)
            ...
            Row(modifier = Modifier.offset(y = -530.dp)) {
                Image(
                    painter = painterResource(id = R.drawable.suytim),
                    contentDescription = "",
                    modifier = Modifier
                        .size(50.dp)
                        .offset(y = -25.dp)
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                Image(
                    painter = painterResource(id = R.drawable.suytim1),
                    contentDescription = "",
                    modifier = Modifier
                        .size(width = 410.dp, height = 260.dp)
                        .align(Alignment.Center)
